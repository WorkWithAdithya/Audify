...
import { Music2, Mail, Lock, Sparkles } from "lucide-react"
    ...
    return (
        <div className="relative flex items-center justify-center min-h-screen overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-green-500/10 rounded-full blur-3xl animate-pulse" style={{animationDelay: '1s'}}></div>
                <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-pink-500/5 rounded-full blur-2xl animate-pulse" style={{animationDelay: '2s'}}></div>
            </div>
                            ...
                            >
                                ...
                                <div className="relative flex items-center justify-center gap-2">
                                    {btnLoading ? (
                                        ...
                                        <>
                                            <span>Sign In</span>
                                            <Music2 className="w-5 h-5 group-hover:rotate-12 transition-transform duration-300" />
                                        </>
                                    )}
                                </div>
                            </button>
